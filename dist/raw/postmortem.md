# /postmortem — Write a mock postmortem for a bug that has not happened yet. Great on-call prep.

Runs on T1 Flow (balanced). Category: Sharing. Source: github.com/taskclan/achilleon/blob/main/skills/postmortem.yml
