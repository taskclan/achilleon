# /rubberduck — The model asks probing questions instead of answering. You find the answer.

Runs on T1 Flow (balanced). Category: Learning. Source: github.com/taskclan/achilleon/blob/main/skills/rubberduck.yml
