# /haiku — A 5-7-5 haiku about the selected function. Captures the soul, not the signature.

Runs on T1 Core (fast). Category: Sharing. Source: github.com/taskclan/achilleon/blob/main/skills/haiku.yml
