# /name — Suggest three better names for the selected symbol, with one line each on why.

Runs on T1 Core (fast). Category: Coding. Source: github.com/taskclan/achilleon/blob/main/skills/name.yml
